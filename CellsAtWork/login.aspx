<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="CellsAtWork.login" %>
        ...
        <div class="wrapper wrapper--w1226">
            <div style="width:100%;height:620px; opacity:.97;" id="logincard" class="animated bounceInDown card card-5">
                ...
                <div id="loginform" runat="server" style="margin-left:100px" class="card-body">
                    ...
                    <div class="col-10">
                       ...
                       <asp:ListItem Value="patient">Patient</asp:ListItem>
                                ...
                                <div   class="input-group">
                                    ...
                                    <input class="input--style-1" type="text" id="userid" runat="server"  placeholder="UserName-Email-PhoneNumber" />
                                   <input class="input--style-1" type="password" id="Text1" runat="server"  placeholder="Password" />
                    ...
                    <div class="col-10">
                         <div   class="input-group">
                         <asp:Button CssClass="btn-submit" width="200px" OnClientClick="return true;" OnClick="Button1_Click" ID="Button1" runat="server" Text="Back to Main" />
                         <asp:Button CssClass="btn-submit" width="200px"  OnClientClick="return true;" OnClick="Button2_Click" ID="Button2" runat="server" Text="LogIn" />
                       </div>
