<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchClinics.aspx.cs" Inherits="CellsAtWork.SearchClinics" %>
    ...
    <form id="form1" runat="server">
        ...
        <nav id="sidebar">
            ...
            <img id="logo" style="margin-left:20px;"src="img\caw.png"/>
               ...
               <!--Search Content-->
 <div id="SearchClinics" class=" content">
 <!---Personal Card-->
                ...
                <div id="Searchform" runat="server" style="margin-left:100px" class="card-body">
                    ...
                    <div class="col-10">
                                <div   class="input-group">
                                    ...
                                    <input class="input--style-1" type="text" id="doctorname" runat="server"  placeholder="All Doctors" />
                                </div>
                            </div>
                    <br/>
                     <div class="col-10">
                                <div   class="input-group">
                                    ...
                                    <br/>
                         <asp:DropDownList AppendDataBoundItems="True" Width="100%" cssClass="input--style-1" ID="DropDownList1" runat="server"></asp:DropDownList>
                                </div>
                            </div>
                    <br/>
                     <div class="col-10">
